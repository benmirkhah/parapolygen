...
//Returns the RGBA object for a web-safe standard color name-------------------
export function name2rgb(name='black') {
  const WEBSAFE = {
  ...
  //------------------------------------------------------------ 
  let color = WEBSAFE[name]; 
  return { R:color[0], G:color[1], B:color[2], A:255 }
}//----------------------------------------------------------------------------

//Returns the RGBA object for a web-safe standard color name-------------------
export function name2hex(name='black') {
  return rgb2hex(name2rgb(name));
}//----------------------------------------------------------------------------
